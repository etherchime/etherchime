  ...
  return (
      ...
      <div className="navbar-brand">
        ...
        <div className="navbar-end">
          ...
          <a id="asideToggle" title="Search for music" aria-label="Search for music" role="button" tabIndex="0" className="navbar-item" href="" onClick={toggleStoryFilters} onKeyPress={(e) => { onEnter(e, toggleStoryFilters); }}>
